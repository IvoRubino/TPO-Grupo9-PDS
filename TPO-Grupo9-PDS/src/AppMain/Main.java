...
import Modelo.Observador.ObservadorNotificacionEmail;
import Modelo.Observador.ObservadorNotificacionPush;
import Modelo.Observador.PartidoObservable;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /* ─────────────────────────────────────────────
           7. Notificaciones con Observer (nuevo)
           ───────────────────────────────────────────── */
        System.out.println("\n=== Notificaciones (Observer) ===");

        PartidoObservable observable = new PartidoObservable();
        ...
        observable.agregarObservador(new ObservadorNotificacionEmail(lucho));
        observable.agregarObservador(new ObservadorNotificacionPush(maria));

        // Simular evento de sistema que dispara notificación
        observable.notificarObservadores("El partido #1 ha sido cancelado por el organizador.");
    }
}